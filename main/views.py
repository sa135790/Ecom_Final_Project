...
MERCHANT_KEY ='Go!u3MuCpUlnfq@Q' #Go!u3MuCpUlnfq@Q LOPeRlFkOA3DGwCp  &VGRrWoFgI@CIukR
@login_required
...
# 			print(order)
			if pay_mode == 'on':
				...
				param_dict = {
		                ...
		                'MID':  'RTbPqV75163185131746',  #RTbPqV75163185131746'
		                'ORDER_ID': str(o_id),
...
# 			print(order)
	...
	if temp == 1:
		...
		param_dict = {
                ...
                'MID':  'RTbPqV75163185131746',
                'ORDER_ID': str(o_id),
                'TXN_AMOUNT': str(subtotal+tax+delev),
                'CUST_ID': request.user.username,
                'INDUSTRY_TYPE_ID': 'Retail',
                'WEBSITE': 'WEBSTAGING', # WEBSTAGING
                'CHANNEL_ID': 'WEB',
                'CALLBACK_URL':'http://127.0.0.1:8000/handlerequest/',
